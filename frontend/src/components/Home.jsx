...
function Home() {
  ...
  return (
    <div className="min-h-screen gradient-bg-3 py-8 px-4">
      <div className="mt-4 bg-white/95 backdrop-blur-sm shadow-2xl rounded-xl max-w-lg lg:max-w-xl mx-auto p-6 border border-white/20">
